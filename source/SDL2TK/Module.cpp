...
namespace SDL2TK
{
    ...
    ///Gamepad Events
    void Module::OnControllerAxis(const SDL_ControllerAxisEvent& event)
    {
        (void)event;
    }

    void Module::OnControllerButtonDown(const SDL_ControllerButtonEvent& event)
    {
        (void)event;
    }

    void Module::OnControllerButtonUp(const SDL_ControllerButtonEvent& event)
    {
        (void)event;
    }
